...
(function () {
  ...
  SRD.weapons = [
    ...
    { name: 'Quarterstaff', dice: '1d6', type: 'bludgeoning', props: ['versatile'] },
    { name: 'Spear', dice: '1d6', type: 'piercing', props: ['thrown', 'versatile'] },
    ...
    { name: 'Battleaxe', dice: '1d8', type: 'slashing', props: ['versatile'] },
    ...
    { name: 'Longsword', dice: '1d8', type: 'slashing', props: ['versatile'] },
    ...
    { name: 'Warhammer', dice: '1d8', type: 'bludgeoning', props: ['versatile'] },
